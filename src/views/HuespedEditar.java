...
public class HuespedEditar extends JFrame {
	 ...
	 * Create the frame.
	 */
	public HuespedEditar(Huesped huesped) {
		this.idHuesped=huesped.getId();
		this.huespedController = new HuespedController();
		setIconImage(Toolkit.getDefaultToolkit().getImage(HuespedEditar.class.getResource("/imagenes/lOGO-50PX.png")));
		...
		txtFechaN.getCalendarButton().setIcon(new ImageIcon(HuespedEditar.class.getResource("/imagenes/icon-reservas.png")));
		txtFechaN.getCalendarButton().setBackground(SystemColor.textHighlight);
		txtFechaN.setDateFormatString("yyyy-MM-dd");
		txtFechaN.setCalendar(huesped.getFechaNacimiento());
		...
		imagenFondo.setIcon(new ImageIcon(HuespedEditar.class.getResource("/imagenes/registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(HuespedEditar.class.getResource("/imagenes/Ha-100px.png")));
	...
	//metodo para guardar huesped
	public void actualizarDatosHuesped(){
		Calendar fechaNacimiento = Calendar.getInstance();
		fechaNacimiento.setTime(txtFechaN.getDate());
		Huesped h = new Huesped(this.idHuesped,txtNombre.getText(),txtApellido.getText(),
								fechaNacimiento,
								(String) txtNacionalidad.getSelectedItem(),txtTelefono.getText(),
								Integer.parseInt(txtNreserva.getText()));
		huespedController.modificar(h);
	}
