...
public class RegistroHuesped extends JFrame {
	...
	public void guardarHuesped(){
		...
		Huesped h = new Huesped(txtNombre.getText(),txtApellido.getText(),fechaNacimiento,(String) txtNacionalidad.getSelectedItem(),txtTelefono.getText());
		huespedController.guardar(h,idReserva);
	}
