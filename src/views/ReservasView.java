...
public class ReservasView extends JFrame {
	...
	public int guardarReserva(){
		...
		Reserva r = new Reserva(fechaEntrada,fechaSalida,valor,(String)txtFormaPago.getSelectedItem());


		return reservaController.guardar(r);
	}
